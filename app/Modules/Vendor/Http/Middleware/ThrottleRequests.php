...
namespace App\Modules\Vendor\Http\Middleware;
...
class ThrottleRequests
{
     ...
     */
    protected function buildException(Request $request, string $key, int $maxAttempts, ?callable $responseCallback = null): ThrottleRequestsException
    {
